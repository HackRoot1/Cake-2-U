                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class='sidebar-link' href='{{ route('coupons.index') }}'>
                            <i class="align-middle" data-feather="sliders"></i> <span
                                class="align-middle">Coupons</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a class='sidebar-link' href='{{ route('promotional.banner.index') }}'>
                            <i class="align-middle" data-feather="sliders"></i> <span
                                class="align-middle">Promotional Content</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class='sidebar-link' href='{{ route('newsletter.index') }}'>
                            <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Newsletter
                            </span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a class='sidebar-link' href='{{ route('admin.delivery.slots.index') }}'>
                            <i class="align-middle" data-feather="calendar"></i> <span class="align-middle">Slots</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class='sidebar-link' href='{{ route('admin.delivery.slots.calendar') }}'>
                            <i class="align-middle" data-feather="calendar"></i> <span class="align-middle">Calendar</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class='sidebar-link' href='{{ route('admin.delivery.assignments') }}'>
                            <i class="align-middle" data-feather="shuffle"></i> <span class="align-middle">Assignments</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class='sidebar-link' href='{{ route('admin.delivery.partners.index') }}'>
                            <i class="align-middle" data-feather="users"></i> <span class="align-middle">Partners</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class='sidebar-link' href='{{ route('admin.delivery.tracking') }}'>
                            <i class="align-middle" data-feather="map-pin"></i> <span class="align-middle">Tracking</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class='sidebar-link' href='{{ route('admin.delivery.issues') }}'>
                            <i class="align-middle" data-feather="alert-circle"></i> <span class="align-middle">Issues</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class='sidebar-link' href='{{ route('admin.delivery.reports') }}'>
                    ...
                    <li class="sidebar-item {{ request()->routeIs('admin.backups.scheduled') ? 'active' : '' }}">
                        <a class='sidebar-link' href='{{ route('admin.backups.scheduled') }}'>
                            <i class="align-middle" data-feather="clock"></i> <span class="align-middle">Scheduled Backups</span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ request()->routeIs('admin.backups.index') ? 'active' : '' }}">
                        <a class='sidebar-link' href='{{ route('admin.backups.index') }}'>
                            <i class="align-middle" data-feather="database"></i> <span class="align-middle">Backup List</span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ request()->routeIs('admin.backups.create') ? 'active' : '' }}">
                        <a class='sidebar-link' href='{{ route('admin.backups.create') }}'>
                            <i class="align-middle" data-feather="plus-circle"></i> <span class="align-middle">Create Backup</span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ request()->routeIs('admin.backups.restore') ? 'active' : '' }}">
                        <a class='sidebar-link' href='{{ route('admin.backups.restore') }}'>
                            <i class="align-middle" data-feather="upload-cloud"></i> <span class="align-middle">Restore Backup</span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ request()->routeIs('admin.backups.security') ? 'active' : '' }}">
                        <a class='sidebar-link' href='{{ route('admin.backups.security') }}'>
                            <i class="align-middle" data-feather="shield"></i> <span class="align-middle">Backup Security</span>
                        </a>
                    </li>
