                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label for="sku" class="form-label">SKU / Product code <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="sku" name="sku"
                                            placeholder="Unique SKU or product code" required>
                                    </div>
                                    ...
                                    <div class="mb-3 col-12">
                                        <label for="short_description" class="form-label">Short description <small
                                                class="text-muted">(max 150 chars)</small></label>
                                        <textarea class="form-control" id="short_description" name="short_description" maxlength="150" rows="2"
                                            placeholder="Short description (max 150 characters)"></textarea>
                                        <small id="shortDescCount" class="form-text text-muted">0/150</small>
                                    </div>

                                    <div class="mb-3 col-12">
                                        <label for="description" class="form-label">Detailed description</label>
                                        <textarea class="form-control rich-text" id="description" name="description" rows="6"
                                ...
                                <div class="row mb-3">
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <input type="number" step="0.01" min="0" class="form-control"
                                            id="cost_price" name="cost_price" placeholder="Cost price">
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        <label for="selling_price" class="form-label">Selling price <span
                                                class="text-danger">*</span></label>
                                        <input type="number" step="0.01" min="0" class="form-control"
                                            id="selling_price" name="selling_price" placeholder="Selling price" required>
                                    </div>
                                    <div class="mb-3 col-md-4">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <input type="number" step="0.01" min="0" class="form-control"
                                            id="sale_price" name="sale_price" placeholder="Auto-calculated" readonly>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-bordered table-sm">
                                            ...
                                            <tbody id="priceHistory">
                                                <tr>
                                                    <td colspan="3" class="text-muted text-center">No history yet</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="mb-3 col-md-6">
                                        <label for="main_image" class="form-label">Main image <span
                                                class="text-danger">*</span></label>
                                        <input type="file" accept="image/*" class="form-control" id="main_image"
                                            name="main_image" required>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="gallery_images" class="form-label">Additional images <small
                                                class="text-muted">(5-10 images)</small></label>
                                        <input type="file" accept="image/*" class="form-control" id="gallery_images"
                                            name="gallery_images[]" multiple data-max-images="10">
                                        <small class="text-muted">You can drag and drop to reorder images after
                                            upload.</small>
                                    </div>
                                    <div class="mb-3 col-12">
                                ...
                                <div class="row mb-3">
                                    <div class="mb-3 col-md-4">
                                        <label for="stock_qty" class="form-label">Stock quantity <span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3 col-md-6 form-check mt-4">
                                        <input type="checkbox" id="track_variants" name="track_variants"
                                            class="form-check-input">
                                        <label for="track_variants" class="form-check-label">Track inventory by
                                            variant</label>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <div id="sizeOptions">
                                            <div class="d-flex mb-2">
                                                ...
                                                <input type="number" step="0.01" name="size_price_modifier[]"
                                                    class="form-control" placeholder="Price modifier">
                                                <button type="button"
                                                    class="btn btn-danger ms-2 btn-sm remove-size">Remove</button>
                                            </div>
                                        </div>
                                        <button type="button" id="addSize" class="btn btn-sm btn-outline-primary">Add
                                            size option</button>
                                    </div>
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <div id="flavorOptions">
                                            <div class="d-flex mb-2">
                                                <input type="text" name="flavors[]" class="form-control me-2"
                                                    placeholder="Flavor name">
                                                <input type="number" step="0.01" name="flavor_price_modifier[]"
                                                    class="form-control" placeholder="Price modifier">
                                                <button type="button"
                                                    class="btn btn-danger ms-2 btn-sm remove-flavor">Remove</button>
                                            </div>
                                        </div>
                                        <button type="button" id="addFlavor" class="btn btn-sm btn-outline-primary">Add
                                            flavor option</button>
                                    </div>
                                    <div class="mb-3 col-md-12">
                                        <label class="form-label">Toppings</label>
                                        <input type="text" name="toppings" class="form-control"
                                            placeholder="Comma-separated toppings">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <div class="form-check">
                                            <input type="checkbox" id="custom_message" name="custom_message"
                                            class="form-check-input">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <div class="form-check">
                                            <input type="checkbox" id="custom_request" name="custom_request"
                                            class="form-check-input">
                                            <label for="custom_request" class="form-check-label">Allow custom request text
                                                area</label>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div>
                                            <label class="me-2"><input type="checkbox" name="dietary[]"
                                                    value="Veg"> Veg</label>
                                            <label class="me-2"><input type="checkbox" name="dietary[]"
                                                    value="Eggless"> Eggless</label>
                                            <label class="me-2"><input type="checkbox" name="dietary[]"
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" name="allergies" id="allergies" class="form-control"
                                            placeholder="Contains nuts, dairy, eggs...">
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        <label for="shelf_life" class="form-label">Shelf life / Expiry</label>
                                        <input type="text" name="shelf_life" id="shelf_life" class="form-control"
                                            placeholder="e.g., 7 days">
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        <label for="storage_instructions" class="form-label">Storage instructions</label>
                                        <input type="text" name="storage_instructions" id="storage_instructions"
                                            class="form-control">
                                    </div>
                                    <div class="mb-3 col-md-4">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <select name="delivery_slots[]" id="delivery_slots" class="form-control"
                                            multiple>
                                        </select>
                                    </div>
                                    <div class="mb-3 col-md-3">
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <input type="number" name="max_order_qty" id="max_order_qty"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="mb-3 col-md-3 form-check">
                                        <input type="checkbox" id="new_arrival" name="new_arrival"
                                            class="form-check-input">
                                ...
                                <div class="row mb-3">
                                    <div class="mb-3 col-12">
                                        <label for="related_products" class="form-label">Related / Complementary products
                                            (max 5)</label>
                                        <select id="related_products" name="related_products[]" class="form-control"
                                            multiple>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 d-flex gap-2">
                                        ...
                                        <button type="submit" name="action" value="continue"
                                            class="btn btn-secondary">Save and continue editing</button>
                                        <button type="submit" name="action" value="publish"
                                            class="btn btn-primary">Save and publish</button>
                                        <button type="submit" name="action" value="add_another"
                                            class="btn btn-outline-primary">Save and add another</button>
                                    </div>
                                </div>
                            </form>
                        </div>
