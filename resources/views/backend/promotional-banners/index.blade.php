                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row g-2 mb-3 align-items-center">
                                ...
                                <div class="col-12 col-md-2">
                                    <div class="d-flex">
                                        <label class="me-2 mt-1">Location</label>
                                        <select name="location" class="form-select w-auto">
                                            <option value="">All</option>
                                            <option value="home" {{ request('location') == 'home' ? 'selected' : '' }}>Home</option>
                                            <option value="category" {{ request('location') == 'category' ? 'selected' : '' }}>Category</option>
                                            <option value="seasonal" {{ request('location') == 'seasonal' ? 'selected' : '' }}>Seasonal</option>
                                            <option value="flash" {{ request('location') == 'flash' ? 'selected' : '' }}>Flash Sale</option>
                                            <option value="newsletter" {{ request('location') == 'newsletter' ? 'selected' : '' }}>Newsletter</option>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-hover mb-0 align-middle">
                                            ...
                                            <tbody>
                                                ...
                                                <tr data-id="3" data-href="{{ route('banner.edit', 3) }}">
                                                    ...
                                                    <td class="d-none d-md-table-cell">Newsletter</td>
