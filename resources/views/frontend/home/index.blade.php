...
@section('content')
    ...
    <section class="hero-area style-two bg-f position-relative z-1">
        <img src="{{ asset('assets/img/hero/shape-1.png') }}" alt="Shape" class="hero-shape-one position-absolute z-n1 animationFramesTwo">
        <img src="{{ asset('assets/img/hero/shape-2.png') }}" alt="Shape" class="hero-shape-two position-absolute z-n1 moveHorizontal">
        <img src="{{ asset('assets/img/hero/shape-3.png') }}" alt="Shape" class="hero-shape-three position-absolute z-n1 bounce">
                ...
                <div class="col-lg-6">
                    <div class="hero-content mb-lg-30">
                        ...
                        <div class="btn-wrap d-flex flex-wrap align-items-center">
                            <a href="#" class="btn style-two position-relative z-1 round-10">Browse
                                Our Menu</a>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="hero-slide-item">
                                        <img src="{{ asset('assets/img/hero/hero-slide-1.png') }}" alt="Image" class="d-block mx-auto">
                                        <div class="product-card bg-white d-flex flex-wrap align-items-center round-20">
                                            <div class="product-info">
                                                <h3 class="fs-20 fw-light mb-1"><a href="{{ route('frontend.pages.shop.product-details', 1) }}"
                                            ...
                                            <button
                                                class="add-to-cart border-0 bg_primary d-flex flex-column align-items-center justify-content-center rounded-circle"><img
                                                    src="{{ asset('assets/img/icons/bag-pink.svg') }}" alt="Icon"
                                ...
                                <div class="swiper-slide">
                                    <div class="hero-slide-item">
                                        <img src="{{ asset('assets/img/hero/hero-slide-2.png') }}" alt="Image" class="d-block mx-auto">
                                        <div
                                ...
                                <div class="swiper-slide">
                                    <div class="hero-slide-item">
                                        <img src="{{ asset('assets/img/hero/hero-slide-3.png') }}" alt="Image" class="d-block mx-auto">
                                        <div
                                            class="product-card style-six bg-white d-flex flex-wrap align-items-center round-20 mb-25">
                                            <div class="product-info">
                                                <h3 class="fs-20 fw-light mb-1"><a href="{{ route('frontend.pages.shop.product-details', 1) }}"
    ...
    <section class="category-area pt-120 pb-90">
        <div class="container style-one">
            ...
            <div class="category-card-wrap style-one d-flex flex-wrap justify-content-xxl-between justify-content-center">
                <div class="category-card style-one text-center mb-30">
                    <div class="category-img position-relative rounded-circle d-block mx-auto transition">
                        <img src="{{ asset('assets/img/category/gelato.jpg') }}" alt="Image" class="rounded-circle transition">
                        <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="position-absolute top-0 start-0 w-100 h-100"></a>
                    </div>
                    <h3 class="fs-24 fw-normal"><a href="{{ route('frontend.pages.shop.product-details', 1) }}"
                            class="text-title link-hover-primary">Vegan Gelato</a></h3>
                    <span>(10 Products)</span>
                </div>
                <div class="category-card style-one text-center mb-30">
                    <div class="category-img position-relative rounded-circle d-block mx-auto transition">
                        <img src="{{ asset('assets/img/category/icecream.jpg') }}" alt="Image" class="rounded-circle transition">
                        <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="position-absolute top-0 start-0 w-100 h-100"></a>
                    </div>
                    <h3 class="fs-24 fw-normal"><a href="{{ route('frontend.pages.shop.product-details', 1) }}"
                ...
                <div class="category-card style-one text-center mb-30">
                    <div class="category-img position-relative rounded-circle d-block mx-auto transition">
                        <img src="{{ asset('assets/img/category/yogurt.jpg') }}" alt="Image" class="rounded-circle transition">
                        <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="position-absolute top-0 start-0 w-100 h-100"></a>
                    </div>
                    <h3 class="fs-24 fw-normal"><a href="{{ route('frontend.pages.shop.product-details', 1) }}"
                ...
                <div class="category-card style-one text-center mb-30">
                    <div class="category-img position-relative rounded-circle d-block mx-auto transition">
                        <img src="{{ asset('assets/img/category/rolled-icecream.jpg') }}" alt="Image"
                ...
                <div class="category-card style-one text-center mb-30">
                    <div class="category-img position-relative rounded-circle d-block mx-auto transition">
                        <img src="{{ asset('assets/img/category/banana-iceream.jpg') }}" alt="Image"
                            class="rounded-circle transition">
                        <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="position-absolute top-0 start-0 w-100 h-100"></a>
                    </div>
                    <h3 class="fs-24 fw-normal"><a href="{{ route('frontend.pages.shop.product-details', 1) }}"
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div
                        ...
                        <div class="featured-product-info">
                            ...
                            <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="btn style-three position-relative z-1 round-10">Order
                                Now</a>
                        </div>
                        <div class="featured-product-img position-relative z-1">
                            <img src="{{ asset('assets/img/products/cake/featured-product-1.png') }}" alt="Image"
                        ...
                        <img src="{{ asset('assets/img/products/shape-1.png') }}" alt="Shape"
                ...
                <div class="col-lg-6">
                    <div
                        ...
                        <div class="featured-product-img position-relative z-1">
                            <img src="{{ asset('assets/img/products/cake/featured-product-2.png') }}" alt="Image"
                                class="position-relative transition" />
                            <span
                                class="discounted-price text-white d-flex flex-column align-items-center justify-content-center position-absolute"><b
                                    class="fw-semibold bold d-block">$5 </b>only</span>
                        </div>
                        <img src="{{ asset('assets/img/products/shape-2.png') }}" alt="Shape"
                            class="featured-shape position-absolute z-n1" />
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="about-img-wrap position-relative mb-md-30">
                        <div class="about-img-one d-inline-block round-20">
                            <img src="{{ asset('assets/img/about/about-img-3.jpg') }}" alt="Image" class="round-20">
                        </div>
                        <div class="about-img-two d-inline-block position-absolute round-20">
                            <img src="{{ asset('assets/img/about/about-img-4.jpg') }}" alt="Image" class="round-20">
                        </div>
                        <div
                            ...
                            <img src="{{ asset('assets/img/about/award-winning-company-2.svg') }}" alt="Text Image"
                                class="circle-text rotate d-block mx-auto">
                            <img src="{{ asset('assets/img/about/fav-icon.png') }}" alt="Favicon"
                    ...
                    <div class="about-content">
                        ...
                        <ul class="feature-list style-one d-flex flex-wrap list-unstyled mb-18">
                            <li class="position-relative font-secondary fw-normal fs-xxl-18 text-title"><img
                                    src="{{ asset('assets/img/icons/badge-violet.svg') }}" alt="Icon">The atmosphere is
                                perfect</li>
                            <li class="position-relative font-secondary fw-normal fs-xxl-18 text-title"><img
                                    src="{{ asset('assets/img/icons/badge-violet.svg') }}" alt="Icon">We offer something
                                unique</li>
                        </ul>
                        <div class="counter-card-wrap d-flex flex-wrap justify-content-between round-15 mb-45">
                            <div class="counter-card style-one position-relative mb-25">
                                <h4 class="fw-normal fs-36 text-title mb-10"><span class="transition">50</span>+</h4>
                                <p class="fs-xxl-18 fw-normal d-block mb-0">Team Members</p>
                            </div>
                            <div class="counter-card style-one position-relative mb-25">
                                <h4 class="fw-normal fs-36 text-title mb-10"><span class="transition">38</span>+</h4>
                                <p class="fs-xxl-18 fw-normal d-block mb-0">World Outlet</p>
                            </div>
                            <div class="counter-card style-one position-relative mb-25">
                                <h4 class="fw-normal fs-36 text-title mb-10"><span class="transition">100</span>%</h4>
                                <p class="fs-xxl-18 fw-normal d-block mb-0">Customer Satisfaction</p>
                            </div>
                        </div>
                        <a href="{{ route('frontend.pages.about') }}" class="btn style-two position-relative z-1 round-10">More About
                            Us</a>
                    </div>
                </div>
            </div>
    ...
    <div class="move-text-wrapper overflow-hidden mb-120">
        <div class="move-text style-one position-relative z-1">
            <ul class="d-flex align-items-center list-unstyled mb-0">
                ...
                <li>
                    <img src="{{ asset('assets/img/products/cake/product-thumb-10.png') }}" alt="Image" />
                </li>
                <li class="font-secondary text-title">
                    Natural Ingredients
                </li>
                <li>
                    <img src="{{ asset('assets/img/products/cake/product-thumb-11.png') }}" alt="Image" />
                </li>
                <li class="font-secondary text-title">
                    Crafted With Love
                </li>
                <li>
                    <img src="{{ asset('assets/img/products/cake/product-thumb-12.png') }}" alt="Image" />
                </li>
                <li class="font-secondary text-title">
                    Gourmet Treats
                </li>
                <li>
                    <img src="{{ asset('assets/img/products/cake/product-thumb-13.png') }}" alt="Image" />
                </li>
                <li class="font-secondary text-title">
                    Perfect Bites
                </li>
    ...
    <div class="container style-one">
        <div class="offer-area style-two bg-f position-relative z-1 round-30">
            <img src="{{ asset('assets/img/discount/discount-product-3.png') }}" alt="Image" class="offer-img-one z-n1">
            <div class="container text-center">
                ...
                <a href="{{ route('frontend.pages.shop.shop') }}" class="btn style-three position-relative z-1 round-10">Shop
                    Flavours Now</a>
            </div>
            <div class="offer-img-two position-absolute bottom-0 end-0 z-n1">
                ...
                <img src="{{ asset('assets/img/discount/discount-product-4.png') }}" alt="Image">
            </div>
        </div>
    </div>
    <!-- Offer Section End -->
    ...
    <div class="container style-one pt-120 pb-90">
        ...
        <ul class="nav nav-tabs list-unstyled product-tablist style-one d-flex align-items-center justify-content-center w-100 mb-40"
            ...
            <li class="nav-item border-0">
                <button class="nav-link border-0" data-bs-toggle="tab" data-bs-target="#trending" type="button"
                    role="tab">
                    Trending
                </button>
            </li>
            <li class="nav-item border-0">
                <button class="nav-link border-0" data-bs-toggle="tab" data-bs-target="#new_product" type="button"
                    role="tab">
                    New Products
                </button>
            </li>
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                ...
                                <img src="{{ asset('assets/img/products/cake/product-7.png') }}" alt="Product Image"
                                    class="d-block mx-auto" />
                            </div>
                            <ul class="rating list-unstyled mb-15">
                                <li>
                                    <img src="{{ asset('assets/img/icons/star-1.svg') }}" alt="Icon" />
                                </li>
                                <li>
                                    <img src="{{ asset('assets/img/icons/star-1.svg') }}" alt="Icon" />
                                </li>
                            ...
                            <h3 class="fs-24">
                                <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary">Birthday
                                    Cake</a>
                            </h3>
                            <span class="product-price fs-xxl-18 d-block">$70.00</span>
                            <a href="{{ route('frontend.pages.shop.cart') }}" class="btn style-four position-relative z-1 round-10">Add To
                                Cart</a>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                class="product-img d-flex flex-column align-items-center justify-content-center rounded-circle mx-auto">
                                <img src="{{ asset('assets/img/products/cake/product-8.png') }}" alt="Product Image"
                                    class="d-block mx-auto" />
                            </div>
                            <ul class="rating list-unstyled mb-15">
                                <li>
                            ...
                            <h3 class="fs-24">
                                <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary">Blue
                                    Light Cake</a>
                            </h3>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                class="product-img d-flex flex-column align-items-center justify-content-center rounded-circle mx-auto">
                                <img src="{{ asset('assets/img/products/cake/product-9.png') }}" alt="Product Image"
                                    class="d-block mx-auto" />
                            </div>
                            <ul class="rating list-unstyled mb-15">
                                <li>
                            ...
                            <h3 class="fs-24">
                                <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary">Sweet
                                    Bread Cake</a>
                            </h3>
                            <span class="product-price fs-xxl-18 d-block">$70.00</span>
                            <a href="{{ route('frontend.pages.shop.cart') }}" class="btn style-four position-relative z-1 round-10">Add To
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                class="product-img d-flex flex-column align-items-center justify-content-center rounded-circle mx-auto">
                                <img src="{{ asset('assets/img/products/cake/product-10.png') }}" alt="Product Image"
                                    class="d-block mx-auto" />
                            </div>
                            <ul class="rating list-unstyled mb-15">
                                <li>
                            ...
                            <h3 class="fs-24">
                                <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary">Spider
                                    Vanila Cake</a>
                            </h3>
                            <span class="product-price fs-xxl-18 d-block">$70.00</span>
                            <a href="{{ route('frontend.pages.shop.cart') }}" class="btn style-four position-relative z-1 round-10">Add To
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                class="product-img d-flex flex-column align-items-center justify-content-center rounded-circle mx-auto">
                                <img src="{{ asset('assets/img/products/cake/product-11.png') }}" alt="Product Image"
                                    class="d-block mx-auto" />
                            </div>
                            <ul class="rating list-unstyled mb-15">
                                <li>
                            ...
                            <h3 class="fs-24">
                                <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary">Meringue
                                    Soft Cake</a>
                            </h3>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                class="product-img d-flex flex-column align-items-center justify-content-center rounded-circle mx-auto">
                                <img src="{{ asset('assets/img/products/cake/product-12.png') }}" alt="Product Image"
                                    class="d-block mx-auto" />
                            </div>
                            <ul class="rating list-unstyled mb-15">
                                <li>
                            ...
                            <h3 class="fs-24">
                                <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary">Black
                                    Forest Cake</a>
                            </h3>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                class="product-img d-flex flex-column align-items-center justify-content-center rounded-circle mx-auto">
                                <img src="{{ asset('assets/img/products/cake/product-13.png') }}" alt="Product Image"
                                    class="d-block mx-auto" />
                            </div>
                            <ul class="rating list-unstyled mb-15">
                                <li>
                            ...
                            <h3 class="fs-24">
                                <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary">Choco
                                    Cream Cake</a>
                            </h3>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                class="product-img d-flex flex-column align-items-center justify-content-center rounded-circle mx-auto">
                                <img src="{{ asset('assets/img/products/cake/product-14.png') }}" alt="Product Image"
                                    class="d-block mx-auto" />
                            </div>
                            <ul class="rating list-unstyled mb-15">
                                <li>
                            ...
                            <h3 class="fs-24">
                                <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary">Brownie
                                    Sponge Cake</a>
                            </h3>
            ...
            <div class="row align-items-center">
                <div class="col-xxl-5 col-lg-6 pe-xxl-0 order-lg-1 order-2">
                    <div class="wh-content">
                        ...
                        <a href="{{ route('frontend.pages.about') }}" class="btn style-one position-relative z-1 round-10">Discover
                            More</a>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div
                    ...
                    <div
                        ...
                        <img src="assets/img/products/cake/product-thumb-1.png" alt="Image" class="d-block mx-auto" />
                    </div>
            ...
            <div class="col-lg-6">
                <div
                    ...
                    <div
                        class="menu-card-img bg-ash d-flex flex-column align-items-center justify-content-center rounded-circle">
                        <img src="assets/img/products/cake/product-thumb-2.png" alt="Image" class="d-block mx-auto" />
                    </div>
                    <div class="menu-card-info">
                        <h3 class="fs-24">
                            <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary transition">Sponge
                                Cake</a>
                        </h3>
                        <p class="mb-0">
            ...
            <div class="col-lg-6">
                <div
                    ...
                    <div
                        class="menu-card-img bg-ash d-flex flex-column align-items-center justify-content-center rounded-circle">
                        <img src="assets/img/products/cake/product-thumb-3.png" alt="Image" class="d-block mx-auto" />
                    </div>
                    <div class="menu-card-info">
                        <h3 class="fs-24">
                            <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary transition">Chocolate
                                truffle</a>
                        </h3>
                        <p class="mb-0">
            ...
            <div class="col-lg-6">
                <div
                    ...
                    <div
                        class="menu-card-img bg-ash d-flex flex-column align-items-center justify-content-center rounded-circle">
                        <img src="assets/img/products/cake/product-thumb-4.png" alt="Image" class="d-block mx-auto" />
                    </div>
                    <div class="menu-card-info">
                        <h3 class="fs-24">
                            <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary transition">Honey cake</a>
                        </h3>
                        <p class="mb-0">
            ...
            <div class="col-lg-6">
                <div
                    ...
                    <div
                        class="menu-card-img bg-ash d-flex flex-column align-items-center justify-content-center rounded-circle">
                        <img src="assets/img/products/cake/product-thumb-5.png" alt="Image" class="d-block mx-auto" />
                    </div>
                    <div class="menu-card-info">
                        <h3 class="fs-24">
                            <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary transition">Butterscotch
                                cake</a>
                        </h3>
                        <p class="mb-0">
            ...
            <div class="col-lg-6">
                <div
                    ...
                    <div
                        class="menu-card-img bg-ash d-flex flex-column align-items-center justify-content-center rounded-circle">
                        <img src="assets/img/products/cake/product-thumb-6.png" alt="Image" class="d-block mx-auto" />
                    </div>
                    <div class="menu-card-info">
                        <h3 class="fs-24">
                            <a href="{{ route('frontend.pages.shop.product-details', 1) }}" class="text-title link-hover-primary transition">Blueberry
                                Cake</a>
                        </h3>
                        <p class="mb-0">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div
                                    ...
                                    <div class="client-img round-15">
                                        <img src="assets/img/clients/client-11.jpg" alt="Image" class="round-15" />
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div
                                    class="testimonial-card style-one bg-white d-flex flex-wrap align-items-center round-20">
                                    <div class="client-img round-15">
                                        <img src="assets/img/clients/client-12.jpg" alt="Image" class="round-15" />
                                    </div>
                                    <div class="client-quote-wrap">
                                        <div
                                            class="testimonial-title position-relative d-flex flex-wrap align-items-center">
                            ...
                            <div class="swiper-slide">
                                <div
                                    class="testimonial-card style-one bg-white d-flex flex-wrap align-items-center round-20">
                                    <div class="client-img round-15">
                                        <img src="assets/img/clients/client-13.jpg" alt="Image" class="round-15" />
                                    </div>
                                    <div class="client-quote-wrap">
                                        <div
                                            class="testimonial-title position-relative d-flex flex-wrap align-items-center">
    ...
    <div class="container style-one">
        <div class="newsletter-box style-one position-relative overflow-hidden z-1 round-30">
            ...
            <img src="assets/img/newsletter-shape-1.png" alt="Image" class="shape-one position-absolute z-n1" />
            <div class="row">
                <div class="col-xl-8 offset-xl-2 col-lg-8 offset-lg-2 col-md-10 offset-md-1 text-center px-xxl-5">
                    ...
                    <form action="#" class="newsletter-form style-one position-relative">
                        <input type="email" class="w-100 bg-white fw-light border-0 round-10 text-para outline-0"
    ...
    <div class="container style-one pt-120 pb-90">
        <div class="row">
            <div class="col-xl-4 col-md-12 mb-lg-30">
                ...
                <a href="{{ route('frontend.pages.blog.view', 1) }}" class="btn style-two position-relative z-1 round-10">View
                    All News</a>
            </div>
                ...
                <div class="blog-card style-one img-hover-zoom round-20 mb-30">
                    ...
                    <ul class="blog-metainfo list-unstyled mb-12">
                        <li class="fs-15 position-relative">
                            <img src="assets/img/icons/calendar.svg" alt="Icon" /><a href="{{ route('frontend.pages.blog.view', 1) }}">01
                                Aug, 2025</a>
                        </li>
                        <li class="fs-15 position-relative">
                    ...
                    <h3 class="fs-24">
                        <a href="{{ route('frontend.pages.blog.view', 1) }}" class="text-title link-hover-secondary transition">The
                            Art Of Custom Cakes How We
                            Bring
                            Sweetest Ideas To Life</a>
                    </h3>
                    <a href="{{ route('frontend.pages.blog.view', 1) }}" class="btn style-one position-relative z-1 round-10">Read
                        More</a>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="blog-card style-one img-hover-zoom round-20 mb-30">
                    ...
                    <ul class="blog-metainfo list-unstyled mb-12">
                        <li class="fs-15 position-relative">
                            <img src="assets/img/icons/calendar.svg" alt="Icon" /><a href="{{ route('frontend.pages.blog.view', 2) }}">17
                                Aug, 2025</a>
                        </li>
                        <li class="fs-15 position-relative">
                            <img src="assets/img/icons/comment.svg" alt="Icon" />No Comment
                    ...
                    <a href="{{ route('frontend.pages.blog.view', 2) }}" class="btn style-one position-relative z-1 round-10">Read
                        More</a>
                </div>
            </div>
        </div>
